...
namespace _Scripts._Infrastructure.UI.Base
{
    public abstract class AnimatedPanel : MonoBehaviour, IPanel
    {
        ...
        public virtual void Open()
        {
            ...
            _rectTransform.DOScale(_initialScale, animationTime).SetEase(Ease.OutBack);
        }

        public virtual void Close(Action onClosed = null)
        {
            _rectTransform.DOScale(Vector3.zero, animationTime).SetEase(Ease.InBack).OnComplete(() =>
            {
